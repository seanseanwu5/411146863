...
<head>
	...
	<title>吳咏壎的個人網頁1</title>
	<style type="text/css">
		* { font-family:"標楷體"; margin-left:auto; margin-right:auto;}
		h1 {color:blue; font-size:60px;}
		h2 {color:#F9F900; font-size:40px;}
	</style>
	...
	<script>
		...
		function change2() {
  			...
  			document.getElementById("h2text").innerText = "Yung-Hsun Wu";
		}
	</script>
...
<body>
	...
	<table width="70%">
		<tr>
			<td>
				<img src="cliff.jpg" width="111%" id="pic" onmouseover="change1()" onmouseout="change2()"></img>
			</td>>

			<td>
				<h1>吳咏壎</h1>
				<h2 id="h2text">Yung-Hsun Wu</h2>
			</td>
		</tr>
	</table>
